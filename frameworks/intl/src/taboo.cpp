...
const std::string Taboo::BLOCKED_LANG_TAG = "blocked_lang";
const std::string Taboo::BLOCKED_CITY_TAG = "blocked_city";
const std::string Taboo::BLOCKED_PHONE_NUMBER_TAG = "blocked_phonenumber";
