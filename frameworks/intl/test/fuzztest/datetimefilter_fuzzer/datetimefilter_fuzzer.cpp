...
namespace OHOS {
    bool DoSomethingTestWithMyAPI(const uint8_t* data, size_t size)
    {
        ...
        MatchedDateTimeInfo* matchedDateTimeInfo2 = new MatchedDateTimeInfo(size, size, input);
