    ...
    ani_string skeleton, ani_object locale)
{
    ...
    if (!obj) {
        HILOG_ERROR_I18N("SimpleNumberFormatConstructor: create I18nSimpleNumberFormatAddon failed.");
        return nullptr;
    }
    ...
    static const char *className = "L@ohos/i18n/i18n/SimpleNumberFormat;";
